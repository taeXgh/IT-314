...
DROP TABLE bb_test2;
DROP TABLE bb_test1;
DROP TABLE bb_blocktest;
DROP VIEW bb_basketitem_vu;
DROP TABLE bb_promo;
DROP TABLE bb_promolist;
DROP TABLE bb_BasketStatus;
DROP TABLE bb_tax;
DROP TABLE bb_shipping;
DROP TABLE bb_basketItem;
DROP TABLE bb_basket;
DROP TABLE bb_ProductOptionDetail;
DROP TABLE bb_ProductOptionCategory;
DROP TABLE bb_ProductOption;
DROP TABLE BB_Shopper;
DROP TABLE bb_Product_request;
DROP TABLE BB_Product;
DROP TABLE BB_Department;
